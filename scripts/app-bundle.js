...
define('contact-detail',["require", "exports", "aurelia-event-aggregator", "./web-api", "./messages", "./utility"], function (require, exports, aurelia_event_aggregator_1, web_api_1, messages_1, utility_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('contact-list',["require", "exports", "aurelia-event-aggregator", "./web-api", "./messages"], function (require, exports, aurelia_event_aggregator_1, web_api_1, messages_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('contact',["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
...
define('loading-indicator',["require", "exports", "nprogress", "aurelia-framework"], function (require, exports, nprogress, aurelia_framework_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.LoadingIndicator = aurelia_framework_1.decorators(aurelia_framework_1.noView(['nprogress/nprogress.css']), aurelia_framework_1.bindable({ name: 'loading', defaultValue: false })).on((function () {
        function class_1() {
        }
        class_1.prototype.loadingChange = function (newValue) {
            if (newValue) {
                nprogress.start();
            }
            else {
...
define('resources/elements/loading-indicator',["require", "exports", "nprogress", "aurelia-framework"], function (require, exports, nprogress, aurelia_framework_1) {
    ...
    exports.LoadingIndicator = aurelia_framework_1.decorators(aurelia_framework_1.noView(['nprogress/nprogress.css']), aurelia_framework_1.bindable({ name: 'loading', defaultValue: false })).on((function () {
        ...
        class_1.prototype.loadingChanged = function (newValue) {
            if (newValue) {
                nprogress.start();
            }
            else {
